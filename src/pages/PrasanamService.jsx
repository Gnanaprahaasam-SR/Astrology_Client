...
const PrasanamOptions = [
    { value: 'vethalaiPrasanam', label: 'Vethalai Prasanam' },
    { value: 'sooliPrasanam', label: 'Sooli Prasanam' },
    { value: 'kulatheivaPrasanam', label: 'Kulatheiva Prasanam' },
    { value: 'astamangalaPrasanam', label: 'Astamangala Prasanam' },
]
...
const PrasanamService = () => {
    ...
    useEffect(() => {
        let newCost = "";
        if (bookingDetails.type === "vethalaiPrasanam") {
            newCost = 1000;
        } else if (bookingDetails.type === "astamangalaPrasanam") {
            newCost = "";
        } else {
            newCost = 5000;
        }
        setValues({ cost: newCost });
    }, [bookingDetails.type]);
    ...
    useEffect(() => {
        if (bookingDetails?.type && bookingDetails?.bookingDate) {
            fetchAvailableSlots();
        }
    }, [bookingDetails?.type, bookingDetails?.bookingDate]);
    ...
    const handleBooking = async () => {
        ...
        if (!bookingDetails.userName || !bookingDetails.mobile || !bookingDetails.address || !bookingDetails.bookingDate || bookingDetails.time.length === 0 || !bookingDetails.type || !bookingDetails.count) {
        ...
        <section className="booking">
            ...
            <div className="container col-12 col-md-9 py-4 ">
                ...
                <div className="row shadow p-4 m-1 rounded-4 booking-card">
                    <h2 className="title text-center mb-3">{t("service.prasanamBooking")}</h2>
...
export default PrasanamService;
